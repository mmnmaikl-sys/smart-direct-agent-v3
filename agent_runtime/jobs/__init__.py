...
from agent_runtime.jobs import (  # noqa: E402
    ...
    impact_tracker_job,
    landing_critic,
    lead_quality_uploader,
    learner,
    main_campaigns_watchdog,
    metrika_health_check,
    offline_conversions,
...
JOB_REGISTRY: dict[str, JobCallable] = {
    ...
    "funnel_cr_tracker": funnel_cr_tracker.run,
    "health_checker": health_checker.run,
    "main_campaigns_watchdog": main_campaigns_watchdog.run,
    "impact_tracker": impact_tracker_job.run,
    "landing_critic": landing_critic.run,
    "lead_quality_uploader": lead_quality_uploader.run,
    "learner": learner.run,
    "metrika_health_check": metrika_health_check.run,
    ...
    "pre_launch_validator": pre_launch_validator.run,
    "query_analyzer": query_analyzer.run,
    "regression_watch": regression_watch.run,
    "settings_reconciler": settings_reconciler.run,
